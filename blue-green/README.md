...
```
argocd app create --name blue-green --repo https://github.com/dlliang14/argocd-example-apps --dest-server https://kubernetes.default.svc --dest-namespace default --path blue-green && argocd app sync blue-green
```
